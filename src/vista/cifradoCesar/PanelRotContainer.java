 ...
 * @author Jerson
 */
public class PanelRotContainer extends javax.swing.JPanel {

    public JFramePrincipal frm;
    public int rot;
    public boolean isCifrado = true;
    
    public PanelRotContainer(JFramePrincipal frm,int rot) {
        this.rot = rot;
    ...
    private void initComponents() {
        ...
        pnlRetornar = new javax.swing.JPanel();
        ...
        pnlRetornar.setBackground(new java.awt.Color(153, 153, 153));
        pnlRetornar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        pnlRetornar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlRetornar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pnlRetornarMouseClicked(evt);
            }
        });
        pnlRetornar.setLayout(null);

        lblRetornar.setFont(new java.awt.Font("Georgia", 0, 18)); // NOI18N
        lblRetornar.setForeground(new java.awt.Color(255, 255, 255));
        lblRetornar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblRetornar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/png/return1.png"))); // NOI18N
        pnlRetornar.add(lblRetornar);
        lblRetornar.setBounds(10, 5, 40, 40);

        jPanel4.add(pnlRetornar);
        pnlRetornar.setBounds(60, 420, 60, 50);
    ...
    private void pnlRetornarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlRetornarMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_pnlRetornarMouseClicked
    ...
    public javax.swing.JLabel lblRetornar;
    ...
    public javax.swing.JPanel pnlRetornar;
