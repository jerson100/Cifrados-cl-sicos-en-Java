 ...
 * @author Jerson
 */
public class JDialogCifradoAtbash extends javax.swing.JDialog {

    private boolean isCifrado;
    private String abc;
    
    public JDialogCifradoAtbash(java.awt.Frame parent, boolean modal, String texto,boolean isCifrado) {
        super(parent, modal);
        this.abc = ROT.ABECEDARIO;
        this.isCifrado = isCifrado;
        initComponents();
        lblRot.setText("Atbash â™¥");
    ...
    private void initComponents() {
        ...
        pnlTutorial = new vista.cifradoAtbash.PanelAnimacionCifradoAtbash(pnlTutorialContainer);
        ...
        jScrollPane2.setBounds(40, 120, 760, 380);
        ...
        lblTextoIngresado.setForeground(new java.awt.Color(0, 255, 255));
        ...
        jScrollPane3.setBounds(460, 40, 340, 70);
    ...
    */
    private vista.cifradoAtbash.PanelAnimacionCifradoAtbash pnlTutorial;
    /*
